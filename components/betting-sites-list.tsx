                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4">
                  ...
                  <div className="md:col-span-3 p-3 md:p-6 flex flex-col items-center justify-center">
                    <div className="relative w-full max-w-[140px]">
                      <div className="bg-black rounded-lg p-2 md:p-4 shadow-sm mb-2 md:mb-3 w-full h-16 md:h-20 flex items-center justify-center overflow-hidden">
                        <Image
              ...
              <div className="md:hidden flex flex-col gap-3 p-3">
                <div className="grid grid-cols-2 items-start gap-2 min-h-[100px]">
                  <div className="flex justify-center items-center h-full">
                    <div className="bg-black p-2 rounded shadow-sm w-32 h-16 flex items-center justify-center overflow-hidden">
                      <Image
                        src={site.logo || "/placeholder.svg"}
                        alt={site.name}
                        width={100}
